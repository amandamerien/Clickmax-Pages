    ...
    <div className="flex w-full flex-col items-center justify-center px-3 lg:px-20">
      <div className="flex w-full max-w-[1280px] flex-col items-start border-x border-[rgba(255,255,255,0.02)] px-3 lg:px-[37px]">
        <div className="flex w-full max-w-[1210px] flex-col gap-6 border border-[rgba(255,255,255,0.02)] p-6">
          ...
          {/* Top row: logo + links */}
          <div className="flex w-full flex-col items-center gap-3 lg:flex-row lg:items-center lg:justify-between">
            {/* Logo + badge */}
            ...
            <div className="flex items-center">
              <a
                href="#"
                className="pr-3 py-2 text-[12px] font-normal leading-[1.4] text-[#b2b2b3] transition-colors hover:text-white"
              ...
              <a
                href="#"
                className="px-3 py-2 text-[12px] font-normal leading-[1.4] text-[#b2b2b3] transition-colors hover:text-white"
                style={{ fontFamily: "'Inter', sans-serif" }}
              >
                Termos
              </a>
          ...
          {/* Disclaimer */}
          <p
            className="text-center text-[12px] font-normal leading-[1.4] text-[#343436] lg:text-left"
            style={{ fontFamily: "'Inter', sans-serif" }}
          >
